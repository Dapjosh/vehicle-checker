    ...
    if (success) {
      return (
        <div className="text-center">
            ...
            <CardTitle className="text-2xl font-bold tracking-tight mb-2">Password Reset!</CardTitle>
            <CardDescription>
        ...
        <CardHeader className="text-center">
           {!success && !error && !isVerifying && (
             <>
                ...
                <CardTitle className="mt-4 text-2xl font-bold tracking-tight">Reset Your Password</CardTitle>
                <CardDescription>
