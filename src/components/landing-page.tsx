  ...
  const features = [
    {
      ...
      description:
        'Replace paper checklists with easy-to-use digital forms. Drivers can complete inspections in minutes.',
    },
    {
      icon: Truck,
      title: 'Fleet Management',
      description:
        'Keep track of all your vehicles, odometer readings, and assignment history in one central dashboard.',
    },
    {
      icon: ShieldCheck,
      title: 'Compliance & Safety',
      description:
        'Ensure every vehicle is road-worthy before it leaves the lot. Pass/Fail verdicts are logged instantly.',
    },
    {
      icon: BarChart3,
      title: 'Data & Exporting',
      description:
        'Export reports to CSV for analysis. Maintain a permanent audit trail of all inspections.',
    },
  ];
  ...
  return (
    <div className='flex flex-col min-h-screen main-wrap'>
      ...
      <header className='px-4 lg:px-6 gap-2 h-16 flex items-center bg-[#262626] sticky top-0 z-50'>
        <div className='flex items-center gap-2 font-bold text-xl text-primary'>
          <a href='/' className='text-sm text-gray-400'>
            <img
              src='/images/FleetCheckr Logo.svg'
              className='h-12'
              alt='FleetCheckr'
            />
          </a>
        ...
        <nav className='ml-auto flex gap-4 sm:gap-6'>
          <Link
            href='#features'
            className='text-md font-medium text-white hover:underline underline-offset-4 flex items-center'
          >
            Features
          </Link>
          <Link
          ...
          <Link
            href='/sign-in'
            className='border border-yellow-300 px-4 py-2 rounded-md text-md font-medium text-yellow-300 hover:bg-yellow-300 w-20 h-10 sm:h-auto sm:w-auto hover:text-neutral-900 transition flex items-center'
          >
            Log In
          </Link>
        </nav>
      ...
      <main className='flex-1'>
            ...
            <div className='flex flex-col items-center align-start space-y-4 text-center'>
              <div className='flex flex-col items-center space-y-5'>
                ...
                <p className='mx-auto max-w-[700px] text-white md:text-xl font-medium'>
                  Streamline your vehicle checks, ensure compliance, and manage
                  your fleet with our powerful digital inspection platform.
                </p>
              </div>
              <div className='space-y-4 sm:space-x-4 pt-4'>
                <Button
                  className='h-12 px-8 text-lg bg-[#03624C] shadow-lg hover:bg-[#03624C]/80 hover:shadow-xl transition-all hover:-translate-y-0.5'
                  asChild
                >
                  <Link href='#contact'>
                ...
                <Button
                  variant='outline'
                  className='bg-yellow-300/30 h-12 px-8 text-lg backdrop-blur-sm hover:bg-yellow-300/80'
                  asChild
                >
        ...
        <section
          id='features'
          className='w-full py-12 md:py-24 lg:py-32 mx-auto bg-white'
        >
          <div className='container px-4 md:px-6'>
            <div className='flex flex-col items-center justify-center space-y-4 text-center mb-12'>
              ...
              <h2 className='text-3xl font-bold tracking-tighter text-black sm:text-5xl'>
                Everything you need to manage inspections
              </h2>
            </div>
            <div className='grid gap-10 sm:grid-cols-2 md:grid-cols-4'>
              {features.map((feature, i) => (
                ...
                >
                  ...
                  <h3 className='text-xl text-[#03624C] text-center font-bold'>
                    {feature.title}
                  </h3>
        ...
        <section
          id='contact'
          className='w-full py-12 md:py-24 lg:py-32 bg-[#262626] text-white'
        >
          <div className='container px-4 md:px-6'>
            <div className='grid gap-10 lg:grid-cols-2 items-center'>
              <div className='space-y-4'>
                ...
                <p className='max-w-[600px] text-gray-300 md:text-xl'>
                  FleetCheckr is currently in an exclusive access period. Fill
                  out the form to schedule a demo and get your organization
                  onboarded.
                </p>
              ...
              <Card className='text-gray-900 bg-white w-full max-w-md mx-auto'>
                <CardHeader>
                  <CardTitle className='text-[#03624C]'>
                    Request Access
                  </CardTitle>
                  <CardDescription>
                  ...
                  {submitted ? (
                    <div className='flex flex-col items-center justify-center py-10 text-center space-y-4'>
                      ...
                      <p className='text-gray-500'>
                        Thanks for your interest. An administrator will review
                        your request and send an invitation link to your email
                        shortly.
                      </p>
                      <Button
                        variant='outline'
                    ...
                    <form action={handleSubmit} className='space-y-4'>
                      <div className='grid gap-2'>
                        ...
                        <Input
                          id='name'
                          className='bg-[#262626] border-white ring-0 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 text-white outline-none focus:border-white'
                          name='name'
                          required
                      ...
                      <div className='grid gap-2'>
                        ...
                        <Textarea
                          ...
                          className='bg-[#262626] border-white ring-0 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 text-white outline-none focus:border-white'
                          name='message'
                          placeholder='Tell us about your specific inspection needs...'
                        />
                      </div>
                      <Button
                        type='submit'
                        className='w-full bg-[#03624C] hover:bg-[#03624C]/90'
                        disabled={isPending}
                      >
                        {isPending ? (
                          <>
      ...
      <footer className='flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-[#262626]'>
        <p className='text-xs text-gray-500'>
          &copy; 2026 FleetCheckr Inc. All rights reserved.
        </p>
